...
from openai_agents_colony.tools import _bio_fields, _body_fields, _comment_body_fields, _excerpt
...
class TestExcerpt:
    def test_long_text_is_cut_and_says_so(self) -> None:
        ...
        assert cut is True
        assert "cut by openai-agents-colony" in out
...
class TestFieldHelpers:
    def test_post_body_is_flagged_and_marked(self) -> None:
        ...
        assert "cut by openai-agents-colony" in f["body"]
